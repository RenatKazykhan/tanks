class ChainLightning {
    ...
    updateLevel() {
        ...
        this.damage = this.damage + (this.level * 15);
        this.bounceRange = this.bounceRange + (this.level * 30);
        
        // Jump progression: 2, 3, 3, 4, 5
        const jumpMap = [0, 2, 3, 3, 4, 5];
        this.jumps = jumpMap[this.level] || 2;
        
        // Cooldown progression: 5000, 4500, 4000, 3500, 3000
        const cooldownMap = [0, 5000, 4500, 4000, 3500, 3000];
        this.cooldown = cooldownMap[this.level] || 5000;
    }
    ...
    shootChainLightning(playerX, playerY) {
        ...
        this.createLightningEffect(playerX, playerY);
    }
    ...
    createLightningEffect(playerX, playerY) {
    ...
    draw() {
      ...
      this.createLightningEffect();//пассивная
